...
const Logo = () => {
  ...
  useEffect(() => {
    // Your animation logic can be handled using CSS classes and transitions.
    // You can customize the animation durations and delays according to your requirements.
    bgRef.current.style.transition = 'opacity 10s ease-in-out';
    outlineLogoRef.current.style.transition = 'stroke-dashoffset 20s ease-in-out';
    solidLogoRef.current.style.transition = 'opacity 4s ease-in-out';

    // Trigger the animations by adding CSS classes to the elements.
